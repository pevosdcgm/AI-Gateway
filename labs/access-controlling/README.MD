...
__NB__: the source file 'policy.xml' is updated by the notebook. The second time it runs, it fails. Copy
the file policy-orig.xml to policy.xml and then run again.
